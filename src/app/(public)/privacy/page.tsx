    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mt-8 space-y-6 text-neutral-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-neutral-900">2. Uso de los datos</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-neutral-900">3. El código QR</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-neutral-900">4. Seguridad</h2>
            <p>
