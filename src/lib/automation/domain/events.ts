...
export const AUTOMATION_EVENTS = {
  ...
  // Ciclo de vida de promociones — universales, cualquier tipo.
  PROMOTION_CREATED: 'promocion.creada',
  PROMOTION_ACTIVATED: 'promocion.activada',
  PROMOTION_PAUSED: 'promocion.pausada',
  PROMOTION_ARCHIVED: 'promocion.archivada',
...
export const AUTOMATION_EVENT_CATALOG: readonly AutomationEventDef[] = [
  ...
  { id: AUTOMATION_EVENTS.PROMOTION_CREATED, name: 'Promoción creada', description: 'Se creó una nueva promoción.' },
  { id: AUTOMATION_EVENTS.PROMOTION_ACTIVATED, name: 'Promoción activada', description: 'Se activó una promoción.' },
  { id: AUTOMATION_EVENTS.PROMOTION_PAUSED, name: 'Promoción pausada', description: 'Se pausó una promoción activa.' },
  { id: AUTOMATION_EVENTS.PROMOTION_ARCHIVED, name: 'Promoción archivada', description: 'Se archivó una promoción.' },
