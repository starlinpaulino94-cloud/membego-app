...
| **Automation Playbooks** | ✅ E1.1–E1.4 | `src/lib/automation/playbooks` — estrategias comerciales instalables (24 apartados del Documento Maestro) que envuelven automatizaciones reales de E1. E1.1: 20 de captación (`ACQ-*`). E1.2: 18 de onboarding (`ONB-*`). E1.3: 12 de primera compra (`FP-*`). E1.4: 16 de frecuencia (`FREQ-*`, basadas en comportamiento + gancho de IA) + eventos de comportamiento. 66 playbooks universales y editables. Sin migración: reutiliza las tablas de E1. Próximas: E1.5–E1.10. |
