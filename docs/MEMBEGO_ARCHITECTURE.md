...
| **Automation Playbooks** | ✅ E1.1–E1.3 | `src/lib/automation/playbooks` — estrategias comerciales instalables (24 apartados del Documento Maestro) que envuelven automatizaciones reales de E1. E1.1: 20 de captación (`ACQ-*`). E1.2: 18 de onboarding (`ONB-*`) + eventos de ciclo de vida temprano. E1.3: 12 de primera compra (`FP-*`) + eventos de conversión. Universales y editables. Sin migración: reutiliza las tablas de E1. Próximas: E1.4–E1.10. |
